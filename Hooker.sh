...
banner() {
	cat <<- EOF
		...
		${ORANGE}  | |  | |  | /  | | | /  | |  | |   \ \   |  ./.-.  | |        
		${ORANGE}  | |  | |  /  '-/ / /  '-/ /  | |    \ .  /  '-/ /  | |        
		${ORANGE} (___)(___)  '.__./   '.__./  (___ ) (___)  '.__./  (___)       Vison:- 2.1.0
		${ORANGE}
...
banner_small() {
	cat <<- EOF
		${BLUE}
		${BLUE}  ooooo   ooooo                     oooo                           
				 '888'   '888'                     '888                           
				  888     888   .ooooo.   .ooooo.   888  oooo   .ooooo.  oooo d8b 
				  888ooooo888  d88' '88b d88' '88b  888 .8P'   d88' '88b '888""8P 
				  888     888  888   888 888   888  888888.    888ooo888  888     
				  888     888  888   888 888   888  888 '88b.  888    .o  888     
				 o888o   o888o 'Y8bod8P' 'Y8bod8P' o888o o888o 'Y8bod8P' d888b    
                                                            ${WHITE} 2.1
	EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${ORANGE}XORbit ${RED}[ ${ORANGE}HTR-TECH ${RED}]
		${GREEN}Github   ${RED}:  ${CYAN}https://github.com/XORbit-01
		${GREEN}Discord   ${RED}:  ${CYAN}https://discord.gg/EB5TfzVv
